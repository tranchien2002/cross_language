...
def insertCorpus(directory):
    ...
    for f in files:
        try:
            ...
            document = document2json.document_json(title=f, content=content, lang="vietnamese")
    ...
    mongo.bulk_insert("vnmeseTest", documents)




if __name__ == '__main__':
    directoryTestNgram = '/home/tmc/Documents/NLP/cross_language/Test/Vietnamese'
